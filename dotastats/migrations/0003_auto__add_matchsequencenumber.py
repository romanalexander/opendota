...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatchSequenceNumber'
        db.create_table('dotastats_matchsequencenumber', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_match_seq_num', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
        ))
        db.send_create_signal('dotastats', ['MatchSequenceNumber'])


    def backwards(self, orm):
        # Deleting model 'MatchSequenceNumber'
        db.delete_table('dotastats_matchsequencenumber')
